...
/// @title USDTStaking — 100-day fixed-term staking with daily claim and 3% referral bonus
/// @notice Designed for USDT BEP20 on BNB Smart Chain (and TRC20-compatible chains).
contract USDTStaking {
    address public owner;
    address public usdtToken;

    uint256 public dailyRateBps  = 50;            // 0.5% per day = 50 bps (50% over 100 days)
    uint256 public stakeDuration = 100 days;
    uint256 public referralBps   = 300;           // 3%
    uint256 public minStake      = 10 * 1e18;     // 10 USDT (18 decimals on BEP20)
